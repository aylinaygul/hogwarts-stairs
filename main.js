...
const archTexture = textureLoader.load('./assets/arch.jpg');
const stairTexture = textureLoader.load('./assets/stair.jpg');
...
function createWallDoor(x, y, z, angle) {
    ...
    const textureLoader = new THREE.TextureLoader();
    const texture = textureLoader.load('./assets/doorout.jpg');
...
createPicture(4, 2, -24, './assets/guy.jpg', 4, 4.2, 0.25, './assets/frameTexture.jpg');
createPicture(-9 , -4, 5, './assets/guysad.jpg', 3, 3.2, 0.26, './assets/frameTexture.jpg',1.6);
createPicture(-9, 13, 2, './assets/monalisa.jpg', 3, 6, 0.23, './assets/frameTexture.jpg',1.6);
createPicture(9, 7, 5, './assets/manhorse.jpg', 4, 9, 0.21, './assets/frameTexture.jpg',80);
createPicture(-5, 2, -24, './assets/seetwoman8.jpg', 4, 10, 0.27, './assets/frameTexture.jpg');
createPicture(9, 0, -9, './assets/yunan.jpg', 5, 5, 0.26, './assets/frameTexture.jpg',80);
createPicture(0, 17, -24, './assets/view.jpg', 17, 9, 0.26, './assets/frameTexture.jpg');
